...
/******************************************************************************
*
*       Function Name   : driverMainMenu -Function 1
*
...
int driverMainMenu()
{
	...
	printf("\n\tPress,");
	printf("\n\t1. Update Profile");
	printf("\n\t2. Check Booked Trips");
	printf("\n\t3. Mark Completed Trips");
...
/******************************************************************************
*
*       Function Name   : signUpDriver - Function 2
*
...
/******************************************************************************
*
*       Function Name   : signInDriver - Function 3
*
...
/******************************************************************************
*
*       Function Name   : dispDriver - Function 4
*
...
/******************************************************************************
*
*       Function Name   : updateDDetails - Function 5
*
...
/******************************************************************************
*
*       Function Name   : writeDriDetails - Function 6
*
...
int writeDriDetails(DRIVER* head)
{
	...
	fp = fopen("./data/cabDrivers.txt","w+");
	if(fp == NULL)
	{
		perror("\n\tfopen() ");
		return -1;
...
/******************************************************************************
*
*       Function Name   : loadDriDetails - Function 7
*
...
DRIVER* loadDriDetails()
{
	...
	fp = fopen("./data/cabDrivers.txt","r+");
	if(fp == NULL)
	{
		perror("\n\tfopen() ");
		return NULL;
...
/******************************************************************************
*
*       Function Name   : tokenizeDRIVER - Function 8
*
