...
int main()
{
	...
	headD = loadDriDetails(dd);/*loading User details from Driver details*/
        headT = loadTripDetails(tt);/*loading User details from Trip details*/
	while(1){
		ch = mainMenu();
		switch(ch)
		{
			...
			case 2:
				...
				switch(ch)
				{
					...
					case 2:
						...
						{
                       		printf("\n\tInvalid Cab Driver or password\n");
