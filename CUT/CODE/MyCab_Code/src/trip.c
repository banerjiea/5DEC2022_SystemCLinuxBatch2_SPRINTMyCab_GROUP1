...
/******************************************************************************
*
*       Function Name   : bookTrip Function -1
*
...
/******************************************************************************
*
*       Function Name   : printBook Function -2
*
...
/******************************************************************************
*
*       Function Name   : dispTrip Function -3
*
...
/******************************************************************************
*
*       Function Name   : markCompleteTrips Function-4
*
...
/******************************************************************************
*
*       Function Name   : writeTripDetails Function-5
*
...
int writeTripDetails(TRIP* head)
{
	...
	fp = fopen("./data/BookedTrip.txt","w+");
	if(fp == NULL)
	{
		perror("\n\tfopen() ");
		return -1;
...
/******************************************************************************
*
*       Function Name   : loadTripDetails Function-6
*
...
TRIP* loadTripDetails()
{
	...
	fp = fopen("./data/BookedTrip.txt","r+");
	if(fp == NULL)
	{
		perror("\n\tfopen() ");
		return NULL;
...
/******************************************************************************
*
*       Function Name   : tokenizeTRIP Function-7
*
